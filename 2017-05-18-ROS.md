...
docker run -it -e NO_AT_BRIDGE=1 -e QT_X11_NO_MITSHM=1 -e DISPLAY=:0 -v /tmp/.X11-unix:/tmp/.X11-unix -v /tmp/.docker.xauth:/tmp/.docker.xauth -e XAUTHORITY=/tmp/.docker.xauth -p 8585:8585 -v /home/adioshun/docker_share:/root/share adioshun/ros:Rviz /bin/bash
...
pip install catkin_pkg rospkg yaml
