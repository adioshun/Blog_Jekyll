...
sudo docker run -i -t -p 2222:22 -p 8585:8080 --volume /home/adioshun/docker:/root --name 'Ubuntu' ubuntu /bin/bash 
sudo nvidia-docker run -i -t -p 2222:22 -p 8585:8080 --volume /home/adioshun/docker:/root --name 'Ubuntu' ubuntu /bin/bash 
```
